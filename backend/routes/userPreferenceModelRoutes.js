...
router.delete('/users/cuisine-preferences', userPreferenceController.removeCuisinePreference);
...
router.delete('/users/restaurant-preferences', userPreferenceController.removeRestaurantPreference);
