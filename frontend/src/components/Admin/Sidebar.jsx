...
const AdminSidebar = () => {
  ...
  const tabs = [
    { name: 'My Restaurants', icon: <HomeIcon className="h-5 w-5" />, path: '/admin/restaurants' },
    { name: 'Add Restaurant', icon: <PlusCircleIcon className="h-5 w-5" />, path: '/admin/new/restaurant' },
    { name: 'Profile', icon: <UserCircleIcon className="h-5 w-5" />, path: '/admin/profile' },
  ];
