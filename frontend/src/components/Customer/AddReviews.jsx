...
const AddReviews = () => {
  ...
  const [restaurants, setRestaurants] = useState([
    ...
    { name: "SuAddld", cuisine: "Japanese", rating: 4.8 },
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl mb-6 flex justify-start space-x-4">
        <Link to="/customer/reviews" className="py-2 px-5 bg-theme-pink text-white text-base font-semibold rounded hover:bg-pink-600 transition duration-200">
          Add Review
        </Link>
        <Link to="/customer/reviews/past" className="py-2 px-5 bg-gray-300 text-gray-800 text-base font-semibold rounded hover:bg-gray-400 transition duration-200">
          Past Reviews
        </Link>
      </div>
